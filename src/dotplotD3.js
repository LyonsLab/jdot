function MultiDotPlot(id, config) {
    ...
    this.constructor = function() {
        ...
        controls = this.element.append("div")
        ...
        var main = this.element.append("main")
            .style({
                position: "relative",
...
function DotPlot(config) {
    ...
    function position(side, value) {
        ...
        var old = figure.style(side) === "auto" ? 0 : parseInt(figure.style(side));

        figure.style(side, value + "px");
